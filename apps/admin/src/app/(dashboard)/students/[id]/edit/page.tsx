...
export default async function EditStudentPage({
  ...
  const initialData = {
    ...
    ieltsStartScore: ielts?.startScore ?? "",
    ieltsCurrentScore: ielts?.currentScore ?? "",
    ieltsTargetScore: ielts?.targetScore ?? "",
    satEnglishStartScore: satEnglish?.startScore ?? "",
    satEnglishCurrentScore: satEnglish?.currentScore ?? "",
    satEnglishTargetScore: satEnglish?.targetScore ?? "",
    satMathStartScore: satMath?.startScore ?? "",
    satMathCurrentScore: satMath?.currentScore ?? "",
    satMathTargetScore: satMath?.targetScore ?? "",
